...
public class BalanCalculate {
	...
	private int radix = 10; // Mặc định: hệ cơ số 10
	private int sizeRound = 10; // Mặc định: Làm tròn 10 chữ số
	private ConvertNumberCalculate convertNumber = new ConvertNumberCalculate();
	...
	/**
	 * Chuyển 1 số sang đơn vị radian
	 * @param num
	 * @return
	 */
